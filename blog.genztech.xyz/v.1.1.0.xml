...
<script async='async' src='https://www.googletagmanager.com/gtag/js?id=UA-122346776-2'/>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag(&#39;js&#39;, new Date());

  gtag(&#39;config&#39;, &#39;UA-122346776-2&#39;);
</script>
...
<meta content='#1f2762' name='theme-color'/>
<meta content='2730e2bd72df545b181131a137bebed9' name='p:domain_verify'/>
...
<link href='https://fonts.googleapis.com/css?family=Manjari:400,700' rel='stylesheet'/>
...
<Variable name="body.font" description="Font" type="font" default="normal normal 14px Lora" value="normal normal 14px Lora"/>
<Variable name="body.text.color" description="Text Color" type="color" default="#4e4e4e" value="#222222"/>
<Variable name="body.link.color" description="Link Color" type="color" default="#777777" value="#1f2762"/>
<Variable name="body.link.color.hover" description="Hover Color" type="color" default="#000000" value="#000000"/>
</Group>
<Group description="Main Color" selector="">
<Variable name="main.color" description="Main Color" type="color" default="#e04f62" value="#1b1433"/>
</Group>
<Group description="Background Color" selector="">
<Variable name="body.background.color" description="Outer Background Color" type="color" default="#ffffff" value="#ffffff"/>
</Group>
<Group description="Blog Header" selector="">
<Variable name="header.text.font" description="Header Font" type="font" default="55px Raleway"  value="55px Raleway"/>
<Variable name="header.text.color" description="Header Color" type="color" default="#777777"  value="#000000"/>
</Group>
<Group description="Post Titles" selector="">
<Variable name="post.title.font" description="Font" type="font" default="18px Maven Pro" value="18px Maven Pro"/>
<Variable name="post.title.color" description="Color" type="color" default="#444444"  value="#444444"/>
<Variable name="post.title.color.hover" description="Hover Color" type="color" default="#777777"  value="#777777"/>
</Group>
<Group description="Navigation" selector="">
<Variable name="navbar.background" description="Navbar Background Color" type="color" default="#f9eded" value="#1f2762"/>
<Variable name="navbar.text.font" description="Navbar Font" type="font" default="11px Maven Pro" value="12px Maven Pro"/>
<Variable name="navbar.text.color" description="Navbar Text Color" type="color" default="#353535" value="#dfe0e1"/>
<Variable name="navbar.text.color.hover" description="Navbar Text Hover Color" type="color" default="#999999" value="#0dff00"/>
</Group>
<Group description="Widgets" selector="">
<Variable name="widget.title.font" description="Widget Title Font" type="font" default="12px Open Sans" value="12px Open Sans"/>
<Variable name="widget.title.text.color" description="Widget Title Color" type="color" default="#222222" value="#222222"/>
</Group>
<Group description="Social Icons" selector="">
<Variable name="socialz.color" description="Social Icon Color" type="color" default="#343434" value="#0000ff"/>
<Variable name="socialz.color.hover" description="Social Icon Hover Color" type="color" default="#777777" value="#351c75"/>
</Group>
<Group description="Sidebar Social Icons" selector="">
<Variable name="sidebar.social.background" description="Social Icon Background Color" type="color" default="#ffffff" value="#cfe2f3"/>
<Variable name="sidebar.social.color" description="Social Icon Color" type="color" default="#444444" value="#0000ff"/>
<Variable name="sidebar.social.border.color" description="Social Icon Border Color" type="color" default="#f0f0f0" value="rgba(0, 0, 0, 0)"/>
</Group>

<Group description="Label" selector="">
<Variable name="label.font" description="Navbar Font" type="font" default="11px Lato" value="11px Lato"/>
<Variable name="label.color" description="Navbar Text Color" type="color" default="#646464" value="#646464"/>
<Variable name="label.color.hover" description="Navbar Background Color" type="color" default="#aaaaaa" value="#aaaaaa"/>
</Group>
*/
...
.rst-search-form input {
	border: #673AB7 solid 1px !important;
    border-radius: 100px;
...
ul.site-social-networks.secondary-2-primary.style-default.show-title li {
    ...
    border: 1px solid $(sidebar.social.border.color);

 background-color: $(sidebar.social.background);border-radius: 50%;
}
...
span.smg-label {
    display: none;
		...
		#navigation {  background: #1f2762; }
		.menu li a { color: #dfe0e1; }
		.menu li a:hover {  color: #0dff00; }
		
		.menu .sub-menu, .menu .children { background: #1f2762; text-align: left;}
		ul.menu ul a, .menu ul ul a {     color: #dfe0e1;
    border-top: 1px solid #eeeeee; }
		ul.menu ul a:hover, .menu ul ul a:hover { color: #ffffff; background:#333333; }
		
		#top-social a { color:$(socialz.color); }
		#top-social a:hover{ color:$(socialz.color.hover); }
		
		#top-search a:hover { background:#474747; }
		#top-search a:hover { color:#cccccc; }
		
		.widget-title , #sidebar .widget h2, #widget-area .widget h2 { color:$(widget.title.text.color); }
...
*******************************/
.header-top {
    background-image: url(https://1.bp.blogspot.com/-Okkz-ftYb58/X1xzA8iaZBI/AAAAAAAAMyE/kYWnSBsJm1Y2R0A7KzT1eP_mIGeMA2XXACLcBGAsYHQ/s2906/12757.jpg);
    background-size: cover;
}
...
article:first-child .post-header {
    position: absolute;
...
article:first-child .post-header{    margin-top: 0px;
}
...
<b:widget id='Header1' locked='false' title='Blog | Genztech: the generation that is tech (Header)' type='Header' version='1'>
  <b:widget-settings>
    <b:widget-setting name='displayUrl'>http://2.bp.blogspot.com/-6ElAB92GFqA/X1x1fPODN5I/AAAAAAAAMyU/7Xys4YA5KScrgVzsIISVntMXQzSwVSDQgCK4BGAYYCw/s324/promo-05.png</b:widget-setting>
    <b:widget-setting name='displayHeight'>111</b:widget-setting>
    <b:widget-setting name='sectionWidth'>324</b:widget-setting>
    <b:widget-setting name='useImage'>true</b:widget-setting>
    <b:widget-setting name='shrinkToFit'>true</b:widget-setting>
    <b:widget-setting name='imagePlacement'>REPLACE</b:widget-setting>
    <b:widget-setting name='displayWidth'>324</b:widget-setting>
  </b:widget-settings>
...
<b:section id='top-social' showaddelement='yes'>
  <b:widget id='LinkList1' locked='false' title='' type='LinkList' version='1'>
    <b:widget-settings>
      <b:widget-setting name='link-3'>https://www.linkedin.com/company/castynet</b:widget-setting>
      <b:widget-setting name='sorting'>NONE</b:widget-setting>
      <b:widget-setting name='text-1'>twitter</b:widget-setting>
      <b:widget-setting name='link-1'>https://twitter.com/castynet</b:widget-setting>
      <b:widget-setting name='text-0'>google</b:widget-setting>
      <b:widget-setting name='link-2'>https://www.instagram.com/castynet_/?hl=en</b:widget-setting>
      <b:widget-setting name='text-3'>linkedin</b:widget-setting>
      <b:widget-setting name='link-0'><![CDATA[https://www.google.com/search?q=castynet&oq=casty&aqs=chrome.0.69i59j69i57j69i60l4.2692j0j0&sourceid=chrome&ie=UTF-8#lrd=0x182f1737e2bae479:0xb73503c49cc707f,1,,,]]></b:widget-setting>
 ...
 <div class='widget-content'>
     ...
     <b:loop values='data:links' var='link'>
       <a expr:href='data:link.target'><i/><span class='smg-label'><data:link.name/></span></a>
     </b:loop>
...
<b:widget id='HTML11' locked='false' title='top navigation' type='HTML' version='1'>
  <b:widget-settings>
    <b:widget-setting name='content'>&lt;li&gt;&lt;a href=&#39;/&#39;&gt;Home&lt;/a&gt;&lt;/li&gt;
&lt;li&gt;&lt;a href=&#39;https://www.nukesafaris.co.ke/search/label/Apps&#39;&gt;Apps&lt;/a&gt;&lt;/li&gt;
&lt;li&gt;&lt;a href=&#39;https://www.nukesafaris.co.ke/search/label/Coded&#39;&gt;Code&lt;/a&gt;&lt;/li&gt;
&lt;li&gt;&lt;a href=&#39;https://www.nukesafaris.co.ke/search/label/Gadgets&#39;&gt;Gadgets&lt;/a&gt;&lt;/li&gt;
&lt;li style=&quot;color:#dfe0e1;font: 12px Maven Pro;cursor: cell;&quot;&gt;PRODUCTS
&lt;ul class=&#39;sub-menu&#39;&gt;
	&lt;li&gt;&lt;a href=&#39;/p/blog-page_14.html&#39;&gt;Software Studio&lt;/a&gt;&lt;/li&gt;
	&lt;li&gt;&lt;a href=&#39;#&#39;&gt;Magazine&lt;/a&gt;&lt;/li&gt;
	&lt;li&gt;&lt;a href=&#39;#&#39;&gt;Shop&lt;/a&gt;&lt;/li&gt;	
&lt;/ul&gt;
&lt;/li&gt;
&lt;li&gt;&lt;a href=&#39;https://www.nukesafaris.co.ke/p/about-us.html&#39;&gt;About&lt;/a&gt;&lt;/li&gt;</b:widget-setting>
  </b:widget-settings>
  <b:includable id='main'>
						<ul class='menu'>
							<data:content/>
...
<div class='carousel'>
			...
			<script>
							document.write(&quot;&lt;script src=\&quot;/feeds/posts/default?max-results=&quot;+3+&quot;&amp;orderby=published&amp;alt=json-in-script&amp;callback=showrecentposts1\&quot;&gt;&lt;\/script&gt;&quot;);
						</script>				
...
<b:section class='group' id='rubik'>
  <b:widget id='HTML5' locked='false' title='' type='HTML'>
    <b:widget-settings>
      <b:widget-setting name='content'>&lt;div class=&quot;rubik-promo-item&quot; style=&quot;background-image:url(https://1.bp.blogspot.com/-lyGcauw-cPM/XXTAnEHq8VI/AAAAAAAAFkQ/tWcOZiQGAdg56p9fkxwfPuB2Y6CfgNOggCLcBGAs/s1600/software-01.png)&quot;&gt;
               	    &lt;a class=&quot;rubik-promo-link&quot; target=&quot;_blank&quot; href=&quot;https://www.nukesafaris.co.ke/search/label/Software&quot;&gt;&lt;/a&gt;
  ...
  <b:widget id='HTML8' locked='false' title='' type='HTML'>
    <b:widget-settings>
      <b:widget-setting name='content'><![CDATA[<div class="rubik-promo-item" style="background-image: url(https://1.bp.blogspot.com/-pmW5nr1DIj0/XXTAnSI4uqI/AAAAAAAAFkY/Yq59niIIl78XPXOjnNKyUBOy5l5ned9NACLcBGAs/s1600/gadgets-01.png);"><br />               	    <a class="rubik-promo-link" href="https://www.nukesafaris.co.ke/search/label/Gadgets" target="_blank"></a><br />                    <div class="rubik-promo-content"><br />            			            				<h4>Gadgets</h4><br />            			            		</div><br />                </div>]]></b:widget-setting>
    </b:widget-settings>
    <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
  ...
  <b:widget id='HTML7' locked='false' title='' type='HTML'>
    <b:widget-settings>
      <b:widget-setting name='content'>&lt;div class=&quot;rubik-promo-item&quot; style=&quot;background-image:url(https://1.bp.blogspot.com/-Et9gXVHbyYk/XXTAnJCzSrI/AAAAAAAAFkU/N_xXbS1m_Fc5wOS6SkBw-KxLBDrABLd9wCLcBGAs/s1600/code-01.png)&quot;&gt;
               	    &lt;a class=&quot;rubik-promo-link&quot; target=&quot;_blank&quot; href=&quot;https://www.nukesafaris.co.ke/search/label/Coded&quot;&gt;&lt;/a&gt;
                    &lt;div class=&quot;rubik-promo-content&quot;&gt;
            			            				&lt;h4&gt;Code&lt;/h4&gt;
            			            		&lt;/div&gt;
                &lt;/div&gt;</b:widget-setting>
...
<div class='post-tag'><b:loop values='data:post.labels' var='label'><a expr:href='data:label.url + &quot;?max-results=6&quot;' rel='tag'><data:label.name/></a></b:loop></div>	
						...
						by   <a expr:href='data:post.authorProfileUrl' rel='author' title='author profile'>
                        <data:post.author/>
                      </a> - <data:post.timestamp/>						
		</div>		
					</div>
  ...
  <div class='post-meta'>
			...
			<a expr:href='&quot;https://www.facebook.com/sharer.php?u=&quot; + data:post.url + &quot;&amp;title=&quot;+ data:post.title' target='_blank'><div class='sharebox'><i class='fa fa-facebook'/></div></a>
							<a expr:href='&quot;http://twitter.com/share?url=&quot; + data:post.url' target='_blank'><div class='sharebox'><i class='fa fa-twitter'/></div></a>
								<a expr:href='&quot;http://pinterest.com/pin/create/button/?url=&quot; + data:post.url + &quot;&amp;media=&quot; + data:post.firstImageUrl + &quot;&amp;description=&quot; + data:post.title' target='_blank'><div class='sharebox'><i class='fa fa-pinterest'/></div></a>
							<a expr:href='&quot;https://plus.google.com/share?url=&quot; + data:post.url' target='_blank'><div class='sharebox'><i class='fa fa-google-plus'/></div></a>
			...
			<a expr:href='&quot;https://www.facebook.com/sharer.php?u=&quot; + data:post.url + &quot;&amp;title=&quot;+ data:post.title' target='_blank'><div class='sharebox'><i class='fa fa-facebook'/></div></a>
				...
				<b:else/>
					<article class='post'>		
						...
						<script type='text/javascript'>createSummaryAndThumb(&quot;summary<data:post.id/>&quot;,&quot;<data:post.title/>&quot;,&quot;<data:post.url/>&quot;,&quot;<data:post.timestamp/>&quot;,&quot;<data:post.numComments/>&quot;,&quot;<b:loop values='data:post.labels' var='label'><a expr:href='data:label.url + &quot;?max-results=6&quot;' rel='tag'><data:label.name/></a></b:loop>&quot;);</script>  
...
<div class='post-meta'>
  ...
  <div class='comment_count'> <data:post.timestamp/>  <span/><a class='comment-link' expr:href='data:post.addCommentUrl' expr:onclick='data:post.addCommentOnclick'><b:if cond='data:post.numComments == 0'>No <data:top.commentLabel/><b:else/><b:if cond='data:post.numComments == 1'>1 <data:top.commentLabel/><b:else/><data:post.numComments/> <data:top.commentLabelPlural/></b:if></b:if></a>    </div>           
      ...
      gapi.load(&quot;gapi.iframes:gapi.iframes.style.bubble&quot;, function() {
        if (gapi.iframes &amp;&amp; gapi.iframes.getContext) {
          gapi.iframes.getContext().openChild({
              url: &#39;https://draft.blogger.com/navbar.g?targetBlogID\x3d6777833771711360677\x26blogName\x3dBlog+%7C+Genztech:+the+generation+that+...\x26publishMode\x3dPUBLISH_MODE_HOSTED\x26navbarType\x3dDISABLED\x26layoutType\x3dLAYOUTS\x26searchRoot\x3dhttps://blog.genztech.xyz/search\x26blogLocale\x3den_GB\x26v\x3d2\x26homepageUrl\x3dhttps://blog.genztech.xyz/\x26vt\x3d1057243512532147810&#39;,
...
<b:widget id='LinkList2' locked='false' title='Follow Us' type='LinkList' version='1'>
  <b:widget-settings>
    ...
    <b:widget-setting name='link-1'>https://www.linkedin.com/company/castynet</b:widget-setting>
    <b:widget-setting name='text-0'>twitter</b:widget-setting>
    <b:widget-setting name='link-2'>https://www.instagram.com/castynet_/?hl=en</b:widget-setting>
    <b:widget-setting name='link-0'>https://twitter.com/castynet</b:widget-setting>
    <b:widget-setting name='text-2'>Instagram</b:widget-setting>
  </b:widget-settings>
  <b:includable id='main'>
...
<b:if cond='data:title != &quot;&quot;'><h2><data:title/></h2></b:if>
 <div class='widget-content'>
   <ul class='site-social-networks secondary-2-primary style-default show-title'>
     <b:loop values='data:links' var='link'>
       <li><a expr:href='data:link.target'><i/></a></li>
     </b:loop>
   </ul>
   <b:include name='quickedit'/>
 </div>
...
<b:widget id='HTML1' locked='false' title='Subscribe for Goodies' type='HTML'>
  <b:widget-settings>
    <b:widget-setting name='content'>&lt;!-- Begin Mailchimp Signup Form --&gt;
...
&lt;form action=&quot;https://castynet.us20.list-manage.com/subscribe/post?u=548afc8fab669b3c258e7d5cf&amp;amp;id=8e6869543b&quot; method=&quot;post&quot; id=&quot;mc-embedded-subscribe-form&quot; name=&quot;mc-embedded-subscribe-form&quot; class=&quot;validate&quot; target=&quot;_blank&quot; novalidate&gt;
...
&lt;/div&gt;
    ...
    &lt;div style=&quot;position: absolute; left: -5000px;&quot; aria-hidden=&quot;true&quot;&gt;&lt;input type=&quot;text&quot; name=&quot;b_548afc8fab669b3c258e7d5cf_8e6869543b&quot; tabindex=&quot;-1&quot; value=&quot;&quot; /&gt;&lt;/div&gt;
    &lt;div class=&quot;clear&quot;&gt;&lt;input type=&quot;submit&quot; value=&quot;Subscribe&quot; name=&quot;subscribe&quot; id=&quot;mc-embedded-subscribe&quot; class=&quot;button&quot; /&gt;&lt;/div&gt;
    &lt;/div&gt;
&lt;/form&gt;
&lt;/div&gt;

&lt;!--End mc_embed_signup--&gt;</b:widget-setting>
  </b:widget-settings>
  <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
...
<b:widget id='Image1' locked='false' title='' type='Image'>
  <b:widget-settings>
    <b:widget-setting name='displayUrl'>http://1.bp.blogspot.com/-ky-uBjyYRRo/XXTzkVkV_jI/AAAAAAAAFk8/5ZAGz9GCFD4vwHaZDkS-PkTwC16sjlg3QCK4BGAYYCw/s1600/SubscribeViaEmail.gif</b:widget-setting>
    <b:widget-setting name='displayHeight'>70</b:widget-setting>
    <b:widget-setting name='sectionWidth'>347</b:widget-setting>
...
<b:widget id='FeaturedPost1' locked='false' title='Get Entertained' type='FeaturedPost'>
  <b:widget-settings>
    <b:widget-setting name='showSnippet'>true</b:widget-setting>
    <b:widget-setting name='showPostTitle'>true</b:widget-setting>
    <b:widget-setting name='postId'>6204332111227625963</b:widget-setting>
...
<b:widget id='HTML4' locked='false' title='recent posts' type='HTML' version='1'>
  <b:widget-settings>
    <b:widget-setting name='content'>3/recentposts</b:widget-setting>
  </b:widget-settings>
  <b:includable id='main'>	
<b:if cond='data:title'>
    <h2><data:title/></h2>
...
<b:section id='Instagram' showaddelement='yes'/>
	...
	<div class='rst-copyright  '>
		<div class='container'>
				<div class='copyright'>
				  <p class='textc'>copyright &#169; 2020 castynet studios all rights reserved.</p>
        </div>
				</div>
        <div id='bloggg'/>
  </div>
...
<a class='to-top' href='#'><i class='fa fa-long-arrow-up'/></a>		
...
<script>
//<![CDATA[
var bs_pinButtonURL = "https://3.bp.blogspot.com/-zLhq96zYiuc/VCxR6pWcgsI/AAAAAAAAAZc/mmx3OzWeKko/s1600/pin_it.png";
