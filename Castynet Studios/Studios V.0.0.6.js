      ...
      <div class='menu-wrap' id='openHideMenu' style='display: none;'>
        <nav class='menu navigation'>
          <ul class='navbar menu-nav'>
            <li><a class='easing' href='#sectionIntro' onclick='closeNavPage()'>Intro</a></li>
            <li><a class='easing' href='#sectionAbout' onclick='closeNavPage()'>About</a></li>
            <li><a class='easing' href='#sectionResume' onclick='closeNavPage()'>Resume</a></li>
            <li><a class='easing' href='#sectionWorks' onclick='closeNavPage()'>Portfolio</a></li>
            <li><a class='easing' href='#sectionServices' onclick='closeNavPage()'>Services</a></li>
            <li><a class='easing' href='#sectionContact' onclick='closeNavPage()'>Contact</a></li>                        
           </ul>           
        </nav>
      </div>
      <button class='menu-button' onclick='closeNavPage()'><span aria-hidden='true' class='fa fa-bars'/></button>
        ...
        <h4>Here is what you should know</h4>
          <hr/>
                  ...
                  <h3>A bit about us</h3>
                    ...
                    <p>
                            Our mission is to create empowering software across the web and android platforms. We are powered by coffee, unreal imagination &amp; attention to detail.
                    </p>
                    <p>
                        <i>
                    ...
                    <p>
                            If you have a project that you think would be a great fit for us do <a class="easing" href="#sectionContact">
                            reach out.</a>
                    </p>
                  </div>
...
<b:if cond='data:blog.pageType != &quot;static_page&quot;'>
      ...
      <div class='sectionTitle wow fadeInUp animated' style='visibility: visible;'>
            ...
            <h1>A FEW MORE DETAILS</h1>
              ...
              <h4>Know more about the team</h4>
  ...
  <b:include name='quickedit'/>
      ...
      <div class='container'>
          ...
          <div class='col-md-6 col-sm-6 col-xs-12 footerLeft'>
            <p class='foot_er'>
              Copyright &#169; 2019 Castynet Studios 🎓 a Software Engine
            </p>
