        ...
        <h4>Let me introduce myself</h4>
          <hr/>
                  ...
                  <div class='col-md-4 aboutMe aboutProfile wow fadeInUp animated' style='visibility: visible;'>
                    <h1>Profile</h1>
			<!-- Porfile Av -->
         <img alt='Deepak Bhagya' class='profileAv centered' src='http://1.bp.blogspot.com/-rFr29COdkPY/VSEm8-JCKtI/AAAAAAAAAWE/LLsK54keWpQ/s1600/Daksh%2BBhagya.jpg'/>
			<!-- Porfile Av End-->
                  </div>
...
<b:if cond='data:blog.pageType != &quot;static_page&quot;'>
      ...
      <div class='col-md-6 col-sm-6 col-xs-12 resumeLeft'>
        ...
        <h2>Employment</h2>
          ...
          <span class='lnr lnr-briefcase wow bounceIn animated animated' style='visibility: visible;'/>
      ...
      <div class='col-md-6 col-sm-6 col-xs-12 resumeRight'>
        ...
        <h2>Education</h2>
          ...
          <span class='lnr lnr-spell-check wow bounceIn animated animated' style='visibility: visible;'/>
      ...
      <div class='container-fluid'>
        <div class='resumeStats'>
          ...
          <span class='lnr lnr-heart wow bounceIn animated' style='visibility: visible;'/>
...
<b:section class='contact-form' id='contact-form' preferred='yes'>
  ...
  <b:include name='quickedit'/>
      ...
      <div class='icon lnr lnr-map'/>
      <h3>Adress/Street</h3>
      <p>12 Street West Victoria 1234 Australia</p>
      </div>

      <div class='contactBox'>
      <div class='icon lnr lnr-smartphone'/>
      <h3>Phone number</h3>
      <p>+(12) 3456 789 </p>
      </div>

      <div class='contactBox'>
      <div class='icon lnr lnr-briefcase'/>
      <h3>Website</h3>
